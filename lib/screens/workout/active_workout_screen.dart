...
class _ActiveWorkoutScreenState extends State<ActiveWorkoutScreen> {
  ...
  Future<void> _initializeWorkouts() async {
    ...
    try {
      final workoutIds =
          widget.selectedRoutine?.workouts ??
      ...
      setState(() {
        ...
        availableWorkouts = allExercises
            .where((e) => !workoutIds.contains(e.id))
            .toList();
        _initializeSessions();
        isLoading = false;
      });
  ...
  void _addWorkoutToSession(int workoutId) {
    setState(() {
      ...
      final exercise = availableWorkouts.firstWhere((e) => e.id == workoutId);
